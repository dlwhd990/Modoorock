...
import styles from "./adminProgramMissionUploadSurvey.module.css";
import axios from "axios";

const AdminProgramMissionUploadSurvey = ({
  loadMissionList,
    ...
    <form className={styles.form}>
      ...
      <div className={`${styles.content_container} ${styles.container_large}`}>
        ...
        <textarea
          ...
          spellCheck="false"
          placeholder="문제 내용 (설문 링크 URL)"
        ></textarea>
      </div>
      <div className={`${styles.button_container} ${styles.container}`}>
        <button className={styles.button} onClick={insertSurvey}>
          등록
        </button>
...
export default AdminProgramMissionUploadSurvey;
